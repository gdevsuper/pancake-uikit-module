...
var Icon$1i = function (props) {
    ...
    return (React__default['default'].createElement("img", __assign({ src: imgSrc, className: "mobile-icon" }, props)));
};
...
var Logo$2 = function (_a) {
    ...
    var imgSrc = '/new_logo.png';
    return (React__default['default'].createElement("img", __assign({ src: imgSrc }, props)));
};
